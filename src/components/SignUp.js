...
export default function SignUp() {
    ...
    const handleSubmit = async (e) => {
        ...
        if (json.success) {
            ...
            console.log("This user is Already Exist", "danger");
            alert("This user is Already Exist", "danger");
        }
    };
            ...
            <div className="flex lg:items-center lg:justify-between lg:gap-5 flex-col lg:flex-row">
                ...
                <div className="max-w-md w-full mb-10 lg:mb-0 mx-auto rounded-2xl p-4 md:p-8 shadow-input bg-transparent z-50 border-red-200 border-2">
                    ...
                    <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
                      if You Have An Account in iNoteBook please <span onClick={() => navigate("/login")} className="underline text-blue-400 cursor-pointer">Sign In</span>
                    </p>
                    ...
                    <form className="my-8" onSubmit={handleSubmit}>
                        <div className="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2 mb-4">
                            <LabelInputContainer>
                                ...
                                <Input value={credentials.firstName} onChange={onChangeData} id="firstname" name="firstName" placeholder="Guddu" type="text" />
                            </LabelInputContainer>
                            <LabelInputContainer>
                                <Label htmlFor="lastname">Last name</Label>
                                <Input value={credentials.lastName} onChange={onChangeData} name="lastName" id="lastname" placeholder="Gaurav" type="text" />
                            </LabelInputContainer>
                        </div>
